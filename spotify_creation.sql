...
INSERT INTO "user"(surname_user, name_user, birthdate_user, password_user, email_user) values ('Sermon-Thuillier', 'Goustan', '2002-11-12', crypt('gou', gen_salt('md5')) , 'goustan.sermon-thuiller@isen.fr');
...
INSERT INTO album(name_album, date_album, cover_album, id_artist, id_style_album) values ('Sauver l amour', '2017-10-20', 'https://p5.storage.canalblog.com/58/32/636073/125759783_o.jpg', 15, 3); /* 16 */
